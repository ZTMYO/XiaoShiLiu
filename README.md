...
> **声明**  
> 本项目基于 [AGPL-3.0 协议](./LICENSE)，免费开源，仅供学习交流，禁止转卖，谨防受骗。如需商用请保留版权信息，确保合法合规使用，运营风险自负，与作者无关。
...
| [二次开发指南](./doc/DEVELOPER_GUIDE.md) | 品牌改造、作者署名与开源协议义务说明 |
...
- **属地查询：** IP属地查询服务使用 [百度opendata](https://www.baidu.com/)，免费、无需密钥，实现精准的IP属地定位功能
